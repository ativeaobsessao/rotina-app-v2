      ...
      >
        ...
        {showInviteModal ? (
          <div className="bg-white p-6 md:p-8 flex flex-col items-center text-center h-full overflow-y-auto">
            {!inviteLink ? (
              <>
                <div className="w-20 h-20 bg-indigo-50 rounded-full flex items-center justify-center mb-6 shrink-0 shadow-sm border border-indigo-100">
              ...
              <>
                <div className="w-20 h-20 bg-green-50 rounded-full flex items-center justify-center mb-6 shrink-0 shadow-sm border border-green-100">
          ...
          <>
            <div className="flex justify-between items-center px-6 py-5 sm:py-6 bg-white border-b border-gray-100 shrink-0">
              <div>
                <h3 className="text-xl font-bold text-gray-900 tracking-tight">Família e Convites</h3>
                <p className="text-sm text-gray-500 mt-1 font-medium">Pessoas com acesso ao paciente.</p>
              </div>
              <button onClick={onClose} className="p-2.5 text-gray-400 hover:text-gray-700 bg-gray-50 hover:bg-gray-100 rounded-full transition-colors active:scale-95">
                <X className="w-6 h-6" />
              </button>
            </div>
