      ...
      <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 transition-colors pb-safe">
        <div className="flex justify-around items-center h-16 max-w-md mx-auto px-6">
          <button 
            ...
            className={cn("flex flex-col items-center justify-center w-full h-full space-y-1 text-xs font-medium transition-colors", activeTab === 'today' ? "text-gray-900 dark:text-gray-100 dark:text-gray-100" : "text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300")}
          >
